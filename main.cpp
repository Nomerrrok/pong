...
void proection(point2d &p1, point2d &p2)
{
    float dist = -5;
    float scale = 50;
     float x1= window.width / 2. + scale * p1.x * dist / (p1.z + dist);
     float y1 = window.height / 2 - scale * p1.y * dist / (p1.z + dist);
     float x2= window.width / 2. + scale * p2.x * dist / (p2.z + dist);
     float y2= window.height / 2 - scale * p2.y * dist / (p2.z + dist);
     p1.x = x1;
     p1.y = y1;
     p2.x = x2;
     p2.y = y2;
